...
class YahooFetcher(Fetcher):
    ...
    def build_url(symbol: str, begin_datetime: datetime,
        ...
        return 'http://finance.yahoo.com/_td_charts_api/resource/charts;comparisonTickers=;events=div%7Csplit%7Cearn;gmtz=9;indicators=quote;period1={};period2={};queryString=%7B%22s%22%3A%22{}%2BInteractive%22%7D;range=1d;rangeSelected=undefined;ticker={};useMock=false?crumb=ozCjAPL5deu'.format(
